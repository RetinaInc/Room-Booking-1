...
$strings['am'] = 'am';
$strings['pm'] = 'pm';
$strings['Approve Pending Reservations'] = 'Approve Pending Reservations';
$strings['View Past Bookings'] = 'View Past Bookings';
$strings['Past Reservations'] = 'Past Reservations';
$strings['Future Reservations'] = 'Future Reservations';
$strings['Total'] = 'Total';
$strings['Paid'] = 'Paid';
$strings['Everyone one is paid up'] = 'Everyone one is paid up';
$strings['Pending Reservation Payment'] = 'Pending Reservation Payment';
...
$email['reservation_activity_1'] = "%s,\r\n<br />"
			. "You have successfully %s a reservation between %s %s and %s %s for %s located at %s.\r\n\r\n<br/><br/>"
