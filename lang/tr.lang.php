...
$strings['Bookings'] = 'Yer ayýrma';											// @since 1.2.0
$strings['Change My Profile Information/Password'] = 'Profil deðiþtir';		// @since 1.2.0
$strings['Manage My Email Preferences'] = 'Eposta Seçenekleri';				// @since 1.2.0
...
$strings['View Resource Calendar'] = 'Çizelge Takvimi';	// @since 1.2.0
...
$strings['Manage Announcements'] = 'Duyurularý yönet';
$strings['There are no announcements'] = 'Duyuru Yok';
// end since 1.1.0

// @since 1.2.0
$strings['Maximum Participant Capacity'] = 'Azami Katýlýmcý kapasitesi';
$strings['Leave blank for unlimited'] = 'Sýnýrsýz için boþ býrakýnýz';
$strings['Maximum of participants'] = 'Azami %s katýlýmcý sayýsýna ulaþtý';
$strings['That reservation is at full capacity.'] = 'Bu rezervasyon kapasitesini doldurmuþtur.';
$strings['Allow registered users to join?'] = 'Kayýtlý kullanýcýlar katýlabilsin mi?';
$strings['Allow non-registered users to join?'] = 'Kayýtsýz kullanýcýlar katýlabilsin mi?';
$strings['Join'] = 'Katýl';
$strings['My Participation Options'] = 'Katýlýmcý Seçeneklerim';
$strings['Join Reservation'] = 'Rezervasyona Katýl';
$strings['Join All Recurring'] = 'Tüm tekrarlayanlara katýl';
$strings['You are not participating on the following reservation dates because they are at full capacity.'] = 'Aþaðýdaki rezervasyonlara kapasiteleri dolduðundan katýlamýyorsunuz.';
$strings['You are already invited to this reservation. Please follow participation instructions previously sent to your email.'] = 'Bu rezervasyona zaten davetlisiniz. Daha önce size eposta olarak gelen bilgileri takip ediniz.';
$strings['Additional Tools'] = 'Ek Araçlar';
$strings['Create User'] = 'Kullanýcý Yarat';
$strings['Check Availability'] = 'Uygunluðunu kontrol et';
$strings['Manage Additional Resources'] = 'Ek kaynaklarý yönet';
$strings['All Additional Resources'] = 'Tüm ek kaynaklar';
$strings['Number Available'] = 'Numara uygun';
$strings['Unlimited'] = 'Sýnýrsýz';
$strings['Add Additional Resource'] = 'Ek kaynak ekle';
$strings['Edit Additional Resource'] = 'Ek kaynak düzenle';
$strings['Checking'] = 'Kontol ediyor';
$strings['You did not select anything to delete.'] = 'Silmek için bir öge seçmediniz.';
$strings['Added Resources'] = 'Eklenen Kaynaklar';
$strings['Additional resource is reserved'] = 'Ek kaynak %s larýn %s bir seferde uygun';
$strings['All Groups'] = 'Tüm Gruplar';
$strings['Group Name'] = 'Grup Adý';
$strings['Delete Groups'] = 'Gruplarý Sil';
$strings['Manage Groups'] = 'Gruplarý Yönet';
$strings['None'] = 'Hiç';
$strings['Group name is required.'] = 'Grup adý gerekli.';
$strings['Groups'] = 'Gruplar';
$strings['Current Groups'] = 'Varolan Gruplar';
$strings['Group Administration'] = 'Grup Yönetimi';
$strings['Reminder Subject'] = 'Rezervasyon hatýrlatýcý- %s, %s %s';
$strings['Reminder'] = 'Hatýrlatýcý';
$strings['before reservation'] = 'rezervasyondan önce';
$strings['My Participation'] = 'Katýlýmým';
$strings['My Past Participation'] = 'Geçmiþ katýlýmým';
$strings['Timezone'] = 'Zaman Aralýðý';
$strings['Export'] = 'Ýhraç';
$strings['Select reservations to export'] = 'Ýhraç etmek için rezervasyon seç';
$strings['Export Format'] = 'Ýhraç biçimi';
$strings['This resource cannot be reserved less than x hours in advance'] = 'Bu rezervasyon %s saatten az ayýrtýlamaz';
$strings['This resource cannot be reserved more than x hours in advance'] = 'Bu rezervasyon %s saatten çok ayýrtýlamaz';
$strings['Minimum Booking Notice'] = 'En az ayýrtma hatýrlatmasý';
$strings['Maximum Booking Notice'] = 'En çok ayýrtma hatýrlatmasý';
$strings['hours prior to the start time'] = 'saat baþlangýç zamanýndan önce';
$strings['hours from the current time'] = 'saat þu andan itibaren';
$strings['Contains'] = 'Ýçerir';
$strings['Begins with'] = 'Baþlar';
$strings['Minimum booking notice is required.'] = 'En az ayýrtma bilgisi gerekli.';
$strings['Maximum booking notice is required.'] = 'En çok ayýrtma bilgisi gerekli.';
$strings['Accessory Name'] = 'Donatý Adý';
$strings['Accessories'] = 'Donatýlar';
$strings['All Accessories'] = 'Tüm Donatýlar';
$strings['Added Accessories'] = 'Eklenen donatýlar';
// end since 1.2.0
...
$email['Reminder Body'] = "Rezervasyonunuz %s  %s den %s a %s %s yaklaþýyor.";
?>