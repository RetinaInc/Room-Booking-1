...
$conf['app']['weburi'] = 'http://localhost/room_booking';
...
$conf['app']['adminPhone'] = '0131 228 3841';

// cancelation policy time in days

$conf['app']['cancel'] = 7;

// casual booker max booking in months

$conf['app']['casual_booker'] = 6;

//user groups and pay rates
$conf['app']['group_rates']		= array ('External' => '10', 'Internal' => '5', 'Reduced Rate' => '5', 'No Charge' => '0');

// payment methods
$conf['app']['payment']  		= array ('Cheque', 'Standing Order', 'Bank Transfer');	

// The default language code.  This must be included in the language list in langs.php
$conf['app']['defaultLanguage'] = 'en_GB';

// The default language code.  This must be included in the language list in langs.php
$conf['app']['min_time'] = 75;
...
$conf['app']['techEmail'] = 'jordanrs2k1@gmail.com';
...
$conf['app']['title'] = "Edinburgh Gestalt Institute's Room Booking System";
...
$conf['ui']['logoImage'] = 'img/logo2.jpg';

// Welcome message show at login page ['Welcome to phpScheduleIt!']
$conf['ui']['welcome'] = "Welcome to Edinburgh Gestalt Institute's Room Booking System!";
...
$conf['ui']['cancelled'][]      = array ('color' => 'FF7373', 'hover' => '800000', 'text' => 'FFFFFF');
