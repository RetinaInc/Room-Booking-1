...
<?php
        ...
        if ( (($type == RES_TYPE_ADD) || ($type == RES_TYPE_APPROVE)) || (($type == RES_TYPE_MODIFY) && (($c_start_time - $c_cur_time) > (86400 * $days)) &&  (!$res->get_paid()) ))  {
						...
						else 
						{
							switch ($method)
							{
								case "Standing Order":
									...
									$cash='<option value="Bank Transfer" >Bank Transfer</option>';
									break;
								...
								case "Bank Transfer":
									$so = '<option value="Standing Order" >Standing Order</option>';
									$cheque = '<option value="Cheque" >Cheque</option>';
									$cash='	<option value="Bank Transfer"selected>Bank Transfer</option>';							
									break;
							}
					?>	
					<tr>
